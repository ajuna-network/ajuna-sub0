...
namespace HelloKusama.NetApiExt.Generated.Model.polkadot_runtime_parachains.scheduler
{
    ...
    /// <summary>
    /// >> 767 - Composite[polkadot_runtime_parachains.scheduler.ParathreadClaimQueue]
    /// </summary>
    ...
    public sealed class ParathreadClaimQueue : BaseType
    {
        ...
        /// >> queue
        /// </summary>
        private Ajuna.NetApi.Model.Types.Base.BaseVec<HelloKusama.NetApiExt.Generated.Model.polkadot_runtime_parachains.scheduler.QueuedParathread> _queue;
        ...
        public Ajuna.NetApi.Model.Types.Base.BaseVec<HelloKusama.NetApiExt.Generated.Model.polkadot_runtime_parachains.scheduler.QueuedParathread> Queue
        {
            get
            {
                return this._queue;
        ...
        {
            var start = p;
            Queue = new Ajuna.NetApi.Model.Types.Base.BaseVec<HelloKusama.NetApiExt.Generated.Model.polkadot_runtime_parachains.scheduler.QueuedParathread>();
