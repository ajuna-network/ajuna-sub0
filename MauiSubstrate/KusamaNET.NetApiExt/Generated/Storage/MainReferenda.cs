...
namespace HelloKusama.NetApiExt.Generated.Storage
{
    ...
    public sealed class ReferendaStorage
    {
        ...
        public ReferendaStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Referenda", "ReferendumInfoFor"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U32), typeof(HelloKusama.NetApiExt.Generated.Model.pallet_referenda.types.EnumReferendumInfo)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Referenda", "TrackQueue"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U16), typeof(HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT18)));
        ...
        ///  Information concerning any given referendum.
        /// </summary>
        public async Task<HelloKusama.NetApiExt.Generated.Model.pallet_referenda.types.EnumReferendumInfo> ReferendumInfoFor(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = ReferendaStorage.ReferendumInfoForParams(key);
            return await _client.GetStorageAsync<HelloKusama.NetApiExt.Generated.Model.pallet_referenda.types.EnumReferendumInfo>(parameters, token);
        }
        ...
        ///  This should be empty if `DecidingCount` is less than `TrackInfo::max_deciding`.
        /// </summary>
        public async Task<HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT18> TrackQueue(Ajuna.NetApi.Model.Types.Primitive.U16 key, CancellationToken token)
        {
            string parameters = ReferendaStorage.TrackQueueParams(key);
            return await _client.GetStorageAsync<HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT18>(parameters, token);
        }
    ...
    public sealed class ReferendaCalls
    {
        ...
        /// </summary>
        public static Method Submit(HelloKusama.NetApiExt.Generated.Model.kusama_runtime.EnumOriginCaller proposal_origin, HelloKusama.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded proposal, HelloKusama.NetApiExt.Generated.Model.frame_support.traits.schedule.EnumDispatchTime enactment_moment)
        {
