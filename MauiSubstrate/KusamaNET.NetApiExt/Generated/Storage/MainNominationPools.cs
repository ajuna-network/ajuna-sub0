...
namespace HelloKusama.NetApiExt.Generated.Storage
{
    ...
    public sealed class NominationPoolsStorage
    {
        ...
        public NominationPoolsStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("NominationPools", "PoolMembers"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32), typeof(HelloKusama.NetApiExt.Generated.Model.pallet_nomination_pools.PoolMember)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("NominationPools", "BondedPools"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U32), typeof(HelloKusama.NetApiExt.Generated.Model.pallet_nomination_pools.BondedPoolInner)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("NominationPools", "RewardPools"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U32), typeof(HelloKusama.NetApiExt.Generated.Model.pallet_nomination_pools.RewardPool)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("NominationPools", "SubPoolsStorage"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U32), typeof(HelloKusama.NetApiExt.Generated.Model.pallet_nomination_pools.SubPools)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("NominationPools", "Metadata"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U32), typeof(HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT33)));
        ...
        ///  Active members.
        /// </summary>
        public static string PoolMembersParams(HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Active members.
        /// </summary>
        public async Task<HelloKusama.NetApiExt.Generated.Model.pallet_nomination_pools.PoolMember> PoolMembers(HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = NominationPoolsStorage.PoolMembersParams(key);
            return await _client.GetStorageAsync<HelloKusama.NetApiExt.Generated.Model.pallet_nomination_pools.PoolMember>(parameters, token);
        }
        ...
        ///  Storage for bonded pools.
        /// </summary>
        public async Task<HelloKusama.NetApiExt.Generated.Model.pallet_nomination_pools.BondedPoolInner> BondedPools(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = NominationPoolsStorage.BondedPoolsParams(key);
            return await _client.GetStorageAsync<HelloKusama.NetApiExt.Generated.Model.pallet_nomination_pools.BondedPoolInner>(parameters, token);
        }
        ...
        ///  is claimed, the balance comes out fo the reward pool. Keyed by the bonded pools account.
        /// </summary>
        public async Task<HelloKusama.NetApiExt.Generated.Model.pallet_nomination_pools.RewardPool> RewardPools(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = NominationPoolsStorage.RewardPoolsParams(key);
            return await _client.GetStorageAsync<HelloKusama.NetApiExt.Generated.Model.pallet_nomination_pools.RewardPool>(parameters, token);
        }
        ...
        ///  hence the name sub-pools. Keyed by the bonded pools account.
        /// </summary>
        public async Task<HelloKusama.NetApiExt.Generated.Model.pallet_nomination_pools.SubPools> SubPoolsStorage(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = NominationPoolsStorage.SubPoolsStorageParams(key);
            return await _client.GetStorageAsync<HelloKusama.NetApiExt.Generated.Model.pallet_nomination_pools.SubPools>(parameters, token);
        }
        ...
        ///  Metadata for the pool.
        /// </summary>
        public async Task<HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT33> Metadata(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = NominationPoolsStorage.MetadataParams(key);
            return await _client.GetStorageAsync<HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT33>(parameters, token);
        }
        ...
        /// </summary>
        public static string ReversePoolIdLookupParams(HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  accounts are deterministically derived from it.
        /// </summary>
        public async Task<Ajuna.NetApi.Model.Types.Primitive.U32> ReversePoolIdLookup(HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
    ...
    public sealed class NominationPoolsCalls
    {
        ...
        /// </summary>
        public static Method Join(Ajuna.NetApi.Model.Types.Base.BaseCom<Ajuna.NetApi.Model.Types.Primitive.U128> amount, Ajuna.NetApi.Model.Types.Primitive.U32 pool_id)
        {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method BondExtra(HelloKusama.NetApiExt.Generated.Model.pallet_nomination_pools.EnumBondExtra extra)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method Unbond(HelloKusama.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress member_account, Ajuna.NetApi.Model.Types.Base.BaseCom<Ajuna.NetApi.Model.Types.Primitive.U128> unbonding_points)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method WithdrawUnbonded(HelloKusama.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress member_account, Ajuna.NetApi.Model.Types.Primitive.U32 num_slashing_spans)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(member_account.Encode());
            byteArray.AddRange(num_slashing_spans.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method Create(Ajuna.NetApi.Model.Types.Base.BaseCom<Ajuna.NetApi.Model.Types.Primitive.U128> amount, HelloKusama.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress root, HelloKusama.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress nominator, HelloKusama.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress state_toggler)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(amount.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method Nominate(Ajuna.NetApi.Model.Types.Primitive.U32 pool_id, Ajuna.NetApi.Model.Types.Base.BaseVec<HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> validators)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
            byteArray.AddRange(validators.Encode());
            return new Method(41, "NominationPools", 7, "nominate", byteArray.ToArray());
        }
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method SetState(Ajuna.NetApi.Model.Types.Primitive.U32 pool_id, HelloKusama.NetApiExt.Generated.Model.pallet_nomination_pools.EnumPoolState state)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
            byteArray.AddRange(state.Encode());
            return new Method(41, "NominationPools", 8, "set_state", byteArray.ToArray());
        }
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method SetMetadata(Ajuna.NetApi.Model.Types.Primitive.U32 pool_id, Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Primitive.U8> metadata)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
            byteArray.AddRange(metadata.Encode());
            return new Method(41, "NominationPools", 9, "set_metadata", byteArray.ToArray());
        }
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method SetConfigs(HelloKusama.NetApiExt.Generated.Model.pallet_nomination_pools.EnumConfigOp min_join_bond, HelloKusama.NetApiExt.Generated.Model.pallet_nomination_pools.EnumConfigOp min_create_bond, HelloKusama.NetApiExt.Generated.Model.pallet_nomination_pools.EnumConfigOp max_pools, HelloKusama.NetApiExt.Generated.Model.pallet_nomination_pools.EnumConfigOp max_members, HelloKusama.NetApiExt.Generated.Model.pallet_nomination_pools.EnumConfigOp max_members_per_pool)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            ...
            return new Method(41, "NominationPools", 10, "set_configs", byteArray.ToArray());
        }
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method UpdateRoles(Ajuna.NetApi.Model.Types.Primitive.U32 pool_id, HelloKusama.NetApiExt.Generated.Model.pallet_nomination_pools.EnumConfigOp new_root, HelloKusama.NetApiExt.Generated.Model.pallet_nomination_pools.EnumConfigOp new_nominator, HelloKusama.NetApiExt.Generated.Model.pallet_nomination_pools.EnumConfigOp new_state_toggler)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
            ...
            return new Method(41, "NominationPools", 11, "update_roles", byteArray.ToArray());
        }
        ...
        public static Method Chill(Ajuna.NetApi.Model.Types.Primitive.U32 pool_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
            return new Method(41, "NominationPools", 12, "chill", byteArray.ToArray());
        }
    }
