...
namespace HelloKusama.NetApiExt.Generated.Storage
{
    ...
    public sealed class AuthorshipStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Authorship", "Uncles"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT5)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Authorship", "Author"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32)));
        ...
        ///  Uncles
        /// </summary>
        public async Task<HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT5> Uncles(CancellationToken token)
        {
            string parameters = AuthorshipStorage.UnclesParams();
            return await _client.GetStorageAsync<HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT5>(parameters, token);
        }
        ...
        ///  Author of current block.
        /// </summary>
        public async Task<HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> Author(CancellationToken token)
        {
    ...
    public sealed class AuthorshipCalls
    {
        ...
        /// </summary>
        public static Method SetUncles(Ajuna.NetApi.Model.Types.Base.BaseVec<HelloKusama.NetApiExt.Generated.Model.sp_runtime.generic.header.Header> new_uncles)
        {
