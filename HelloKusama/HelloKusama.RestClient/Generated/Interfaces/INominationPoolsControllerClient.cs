...
namespace HelloKusama.RestClient.Generated.Interfaces
{
   ...
   public interface INominationPoolsControllerClient
   {
      ...
      Task<PoolMember> GetPoolMembers(HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
      Task<bool> SubscribePoolMembers(HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
      ...
      Task<BoundedVecT33> GetMetadata(U32 key);
      ...
      Task<U32> GetReversePoolIdLookup(HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
      Task<bool> SubscribeReversePoolIdLookup(HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
