...
namespace HelloKusama.RestClient.Generated.Clients
{
   ...
   public sealed class BabeControllerClient : BaseClient, IBabeControllerClient
   {
      ...
      {
         return await SendRequestAsync<BoundedVecT3>(_httpClient, "babe/underconstruction", HelloKusama.NetApiExt.Generated.Storage.BabeStorage.UnderConstructionParams(key));
      }
      public async Task<bool> SubscribeUnderConstruction(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Babe.UnderConstruction", HelloKusama.NetApiExt.Generated.Storage.BabeStorage.UnderConstructionParams(key));
      }
