...
namespace HelloKusama.RestClient.Generated.Clients
{
   ...
   public sealed class ElectionProviderMultiPhaseControllerClient : BaseClient, IElectionProviderMultiPhaseControllerClient
   {
      ...
      {
         return await SendRequestAsync<SignedSubmission>(_httpClient, "electionprovidermultiphase/signedsubmissionsmap", HelloKusama.NetApiExt.Generated.Storage.ElectionProviderMultiPhaseStorage.SignedSubmissionsMapParams(key));
      }
      public async Task<bool> SubscribeSignedSubmissionsMap(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("ElectionProviderMultiPhase.SignedSubmissionsMap", HelloKusama.NetApiExt.Generated.Storage.ElectionProviderMultiPhaseStorage.SignedSubmissionsMapParams(key));
      }
