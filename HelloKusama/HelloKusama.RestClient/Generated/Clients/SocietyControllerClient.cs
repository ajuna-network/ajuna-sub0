...
namespace HelloKusama.RestClient.Generated.Clients
{
   ...
   public sealed class SocietyControllerClient : BaseClient, ISocietyControllerClient
   {
      ...
      {
         return await SendRequestAsync<BaseTuple<U128, EnumBidKind>>(_httpClient, "society/suspendedcandidates", HelloKusama.NetApiExt.Generated.Storage.SocietyStorage.SuspendedCandidatesParams(key));
      }
      public async Task<bool> SubscribeSuspendedCandidates(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Society.SuspendedCandidates", HelloKusama.NetApiExt.Generated.Storage.SocietyStorage.SuspendedCandidatesParams(key));
      }
      ...
      {
         return await SendRequestAsync<Bool>(_httpClient, "society/suspendedmembers", HelloKusama.NetApiExt.Generated.Storage.SocietyStorage.SuspendedMembersParams(key));
      }
      public async Task<bool> SubscribeSuspendedMembers(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Society.SuspendedMembers", HelloKusama.NetApiExt.Generated.Storage.SocietyStorage.SuspendedMembersParams(key));
      }
      ...
      {
         return await SendRequestAsync<EnumVouchingStatus>(_httpClient, "society/vouching", HelloKusama.NetApiExt.Generated.Storage.SocietyStorage.VouchingParams(key));
      }
      public async Task<bool> SubscribeVouching(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Society.Vouching", HelloKusama.NetApiExt.Generated.Storage.SocietyStorage.VouchingParams(key));
      }
      public async Task<BaseVec<BaseTuple<U32, U128>>> GetPayouts(AccountId32 key)
      {
         return await SendRequestAsync<BaseVec<BaseTuple<U32, U128>>>(_httpClient, "society/payouts", HelloKusama.NetApiExt.Generated.Storage.SocietyStorage.PayoutsParams(key));
      }
      public async Task<bool> SubscribePayouts(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Society.Payouts", HelloKusama.NetApiExt.Generated.Storage.SocietyStorage.PayoutsParams(key));
      }
      public async Task<U32> GetStrikes(AccountId32 key)
      {
         return await SendRequestAsync<U32>(_httpClient, "society/strikes", HelloKusama.NetApiExt.Generated.Storage.SocietyStorage.StrikesParams(key));
      }
      public async Task<bool> SubscribeStrikes(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Society.Strikes", HelloKusama.NetApiExt.Generated.Storage.SocietyStorage.StrikesParams(key));
      }
      public async Task<EnumVote> GetVotes(BaseTuple<AccountId32, AccountId32> key)
      {
         return await SendRequestAsync<EnumVote>(_httpClient, "society/votes", HelloKusama.NetApiExt.Generated.Storage.SocietyStorage.VotesParams(key));
      }
      public async Task<bool> SubscribeVotes(BaseTuple<AccountId32, AccountId32> key)
      {
         return await _subscriptionClient.SubscribeAsync("Society.Votes", HelloKusama.NetApiExt.Generated.Storage.SocietyStorage.VotesParams(key));
      }
      ...
      {
         return await SendRequestAsync<EnumVote>(_httpClient, "society/defendervotes", HelloKusama.NetApiExt.Generated.Storage.SocietyStorage.DefenderVotesParams(key));
      }
      public async Task<bool> SubscribeDefenderVotes(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Society.DefenderVotes", HelloKusama.NetApiExt.Generated.Storage.SocietyStorage.DefenderVotesParams(key));
      }
