...
namespace HelloKusama.RestClient.Generated.Clients
{
   ...
   public sealed class ParaSchedulerControllerClient : BaseClient, IParaSchedulerControllerClient
   {
      ...
      public async Task<BaseVec<BaseVec<HelloKusama.NetApiExt.Generated.Model.polkadot_primitives.v2.ValidatorIndex>>> GetValidatorGroups()
      {
         return await SendRequestAsync<BaseVec<BaseVec<HelloKusama.NetApiExt.Generated.Model.polkadot_primitives.v2.ValidatorIndex>>>(_httpClient, "parascheduler/validatorgroups");
      }
      ...
      public async Task<BaseVec<BaseOpt<HelloKusama.NetApiExt.Generated.Model.polkadot_primitives.v2.EnumCoreOccupied>>> GetAvailabilityCores()
      {
         return await SendRequestAsync<BaseVec<BaseOpt<HelloKusama.NetApiExt.Generated.Model.polkadot_primitives.v2.EnumCoreOccupied>>>(_httpClient, "parascheduler/availabilitycores");
      }
