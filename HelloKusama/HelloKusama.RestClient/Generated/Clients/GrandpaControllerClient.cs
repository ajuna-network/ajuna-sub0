...
namespace HelloKusama.RestClient.Generated.Clients
{
   ...
   public sealed class GrandpaControllerClient : BaseClient, IGrandpaControllerClient
   {
      ...
      {
         return await SendRequestAsync<U32>(_httpClient, "grandpa/setidsession", HelloKusama.NetApiExt.Generated.Storage.GrandpaStorage.SetIdSessionParams(key));
      }
      public async Task<bool> SubscribeSetIdSession(U64 key)
      {
         return await _subscriptionClient.SubscribeAsync("Grandpa.SetIdSession", HelloKusama.NetApiExt.Generated.Storage.GrandpaStorage.SetIdSessionParams(key));
      }
   }
}
