...
namespace HelloKusama.RestClient.Generated.Clients
{
   ...
   public sealed class RegistrarControllerClient : BaseClient, IRegistrarControllerClient
   {
      ...
      {
         return await SendRequestAsync<Id>(_httpClient, "registrar/pendingswap", HelloKusama.NetApiExt.Generated.Storage.RegistrarStorage.PendingSwapParams(key));
      }
      public async Task<bool> SubscribePendingSwap(Id key)
      {
         return await _subscriptionClient.SubscribeAsync("Registrar.PendingSwap", HelloKusama.NetApiExt.Generated.Storage.RegistrarStorage.PendingSwapParams(key));
      }
      public async Task<ParaInfo> GetParas(Id key)
      {
         return await SendRequestAsync<ParaInfo>(_httpClient, "registrar/paras", HelloKusama.NetApiExt.Generated.Storage.RegistrarStorage.ParasParams(key));
      }
      public async Task<bool> SubscribeParas(Id key)
      {
         return await _subscriptionClient.SubscribeAsync("Registrar.Paras", HelloKusama.NetApiExt.Generated.Storage.RegistrarStorage.ParasParams(key));
      }
