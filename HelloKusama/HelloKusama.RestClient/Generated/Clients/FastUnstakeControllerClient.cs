...
namespace HelloKusama.RestClient.Generated.Clients
{
   ...
   public sealed class FastUnstakeControllerClient : BaseClient, IFastUnstakeControllerClient
   {
      ...
      public async Task<U128> GetQueue(HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await SendRequestAsync<U128>(_httpClient, "fastunstake/queue", HelloKusama.NetApiExt.Generated.Storage.FastUnstakeStorage.QueueParams(key));
      }
      public async Task<bool> SubscribeQueue(HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("FastUnstake.Queue", HelloKusama.NetApiExt.Generated.Storage.FastUnstakeStorage.QueueParams(key));
      }
