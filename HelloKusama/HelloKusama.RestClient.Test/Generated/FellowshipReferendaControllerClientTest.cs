...
namespace HelloKusama.RestClient.Test.Generated
{
   ...
   public class FellowshipReferendaControllerClientTest : ClientTestBase
   {
      ...
      public HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT20 GetTestValue16()
      {
         HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT20 result;
         result = new HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT20();
      ...
      public async System.Threading.Tasks.Task TestTrackQueue()
      {
         ...
         // Construct new RPC client to test with.
         FellowshipReferendaControllerClient rpcClient = new FellowshipReferendaControllerClient(_httpClient, subscriptionClient);
         HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT20 mockupValue = this.GetTestValue16();
         ...
         HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT20 rpcResult = await rpcClient.GetTrackQueue(mockupKey);
