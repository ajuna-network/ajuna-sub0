...
namespace HelloKusama.RestClient.Test.Generated
{
   ...
   public class BountiesControllerClientTest : ClientTestBase
   {
      ...
      public HelloKusama.NetApiExt.Generated.Model.pallet_bounties.Bounty GetTestValue3()
      {
         HelloKusama.NetApiExt.Generated.Model.pallet_bounties.Bounty result;
         result = new HelloKusama.NetApiExt.Generated.Model.pallet_bounties.Bounty();
         ...
         result.Status = new HelloKusama.NetApiExt.Generated.Model.pallet_bounties.EnumBountyStatus();
         result.Status.Create(this.GetTestValueEnum<HelloKusama.NetApiExt.Generated.Model.pallet_bounties.BountyStatus>(), this.GetTestValueBaseVoid());
         return result;
      }
      ...
      public async System.Threading.Tasks.Task TestBounties()
      {
         ...
         // Construct new RPC client to test with.
         BountiesControllerClient rpcClient = new BountiesControllerClient(_httpClient, subscriptionClient);
         HelloKusama.NetApiExt.Generated.Model.pallet_bounties.Bounty mockupValue = this.GetTestValue3();
         ...
         HelloKusama.NetApiExt.Generated.Model.pallet_bounties.Bounty rpcResult = await rpcClient.GetBounties(mockupKey);

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT30 GetTestValue6()
      {
         HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT30 result;
         result = new HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT30();
      ...
      public async System.Threading.Tasks.Task TestBountyDescriptions()
      {
         ...
         // Construct new RPC client to test with.
         BountiesControllerClient rpcClient = new BountiesControllerClient(_httpClient, subscriptionClient);
         HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT30 mockupValue = this.GetTestValue6();
         Ajuna.NetApi.Model.Types.Primitive.U32 mockupKey = this.GetTestValueU32();
         ...
         HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT30 rpcResult = await rpcClient.GetBountyDescriptions(mockupKey);

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT15 GetTestValue8()
      {
      ...
      public async System.Threading.Tasks.Task TestBountyApprovals()
      {
         ...
         // Construct new RPC client to test with.
         BountiesControllerClient rpcClient = new BountiesControllerClient(_httpClient, subscriptionClient);
         HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT15 mockupValue = this.GetTestValue8();
         ...
         HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT15 rpcResult = await rpcClient.GetBountyApprovals();
