...
namespace HelloKusama.RestClient.Test.Generated
{
   ...
   public class ChildBountiesControllerClientTest : ClientTestBase
   {
      ...
      public HelloKusama.NetApiExt.Generated.Model.pallet_child_bounties.ChildBounty GetTestValue4()
      {
         HelloKusama.NetApiExt.Generated.Model.pallet_child_bounties.ChildBounty result;
         result = new HelloKusama.NetApiExt.Generated.Model.pallet_child_bounties.ChildBounty();
         ...
         result.Status = new HelloKusama.NetApiExt.Generated.Model.pallet_child_bounties.EnumChildBountyStatus();
         result.Status.Create(this.GetTestValueEnum<HelloKusama.NetApiExt.Generated.Model.pallet_child_bounties.ChildBountyStatus>(), this.GetTestValueBaseVoid());
         return result;
      }
      ...
      public async System.Threading.Tasks.Task TestChildBounties()
      {
         ...
         // Construct new RPC client to test with.
         ChildBountiesControllerClient rpcClient = new ChildBountiesControllerClient(_httpClient, subscriptionClient);
         HelloKusama.NetApiExt.Generated.Model.pallet_child_bounties.ChildBounty mockupValue = this.GetTestValue4();
         ...
         HelloKusama.NetApiExt.Generated.Model.pallet_child_bounties.ChildBounty rpcResult = await rpcClient.GetChildBounties(mockupKey);

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT30 GetTestValue7()
      {
      ...
      public async System.Threading.Tasks.Task TestChildBountyDescriptions()
      {
         ...
         // Construct new RPC client to test with.
         ChildBountiesControllerClient rpcClient = new ChildBountiesControllerClient(_httpClient, subscriptionClient);
         HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT30 mockupValue = this.GetTestValue7();
         Ajuna.NetApi.Model.Types.Primitive.U32 mockupKey = this.GetTestValueU32();
         ...
         HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT30 rpcResult = await rpcClient.GetChildBountyDescriptions(mockupKey);
