...
namespace HelloKusama.RestClient.Test.Generated
{
   ...
   public class SchedulerControllerClientTest : ClientTestBase
   {
      ...
      public HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT26 GetTestValue3()
      {
         HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT26 result;
         result = new HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT26();
         result.Value = new Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Base.BaseOpt<HelloKusama.NetApiExt.Generated.Model.pallet_scheduler.Scheduled>>();
         result.Value.Create(new Ajuna.NetApi.Model.Types.Base.BaseOpt<HelloKusama.NetApiExt.Generated.Model.pallet_scheduler.Scheduled>[] {
                  this.GetTestValue4()});
         return result;
      }
      public Ajuna.NetApi.Model.Types.Base.BaseOpt<HelloKusama.NetApiExt.Generated.Model.pallet_scheduler.Scheduled> GetTestValue4()
      {
         Ajuna.NetApi.Model.Types.Base.BaseOpt<HelloKusama.NetApiExt.Generated.Model.pallet_scheduler.Scheduled> result;
         result = new Ajuna.NetApi.Model.Types.Base.BaseOpt<HelloKusama.NetApiExt.Generated.Model.pallet_scheduler.Scheduled>();
         result.Create(this.GetTestValue5());
         return result;
      }
      public HelloKusama.NetApiExt.Generated.Model.pallet_scheduler.Scheduled GetTestValue5()
      {
         HelloKusama.NetApiExt.Generated.Model.pallet_scheduler.Scheduled result;
         result = new HelloKusama.NetApiExt.Generated.Model.pallet_scheduler.Scheduled();
         result.MaybeId = new Ajuna.NetApi.Model.Types.Base.BaseOpt<HelloKusama.NetApiExt.Generated.Types.Base.Arr32U8>();
         result.MaybeId.Create(this.GetTestValue6());
         result.Priority = this.GetTestValueU8();
         result.Call = new HelloKusama.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded();
         result.Call.Create(this.GetTestValueEnum<HelloKusama.NetApiExt.Generated.Model.frame_support.traits.preimages.Bounded>(), this.GetTestValue7());
         ...
         result.Origin.Create(this.GetTestValueEnum<HelloKusama.NetApiExt.Generated.Model.kusama_runtime.OriginCaller>(), this.GetTestValue9());
         return result;
      }
      public HelloKusama.NetApiExt.Generated.Types.Base.Arr32U8 GetTestValue6()
      {
      ...
      public HelloKusama.NetApiExt.Generated.Model.primitive_types.H256 GetTestValue7()
      {
      ...
      public HelloKusama.NetApiExt.Generated.Model.frame_support.dispatch.EnumRawOrigin GetTestValue9()
      {
      ...
      public async System.Threading.Tasks.Task TestAgenda()
      {
         ...
         // Construct new RPC client to test with.
         SchedulerControllerClient rpcClient = new SchedulerControllerClient(_httpClient, subscriptionClient);
         HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT26 mockupValue = this.GetTestValue3();
         ...
         HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT26 rpcResult = await rpcClient.GetAgenda(mockupKey);
      ...
      public async System.Threading.Tasks.Task TestLookup()
      {
         ...
         HelloKusama.NetApiExt.Generated.Types.Base.Arr32U8 mockupKey = this.GetTestValue12();
