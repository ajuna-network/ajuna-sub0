...
namespace HelloKusama.RestClient.Test.Generated
{
   ...
   public class FastUnstakeControllerClientTest : ClientTestBase
   {
      ...
      public HelloKusama.NetApiExt.Generated.Model.pallet_fast_unstake.types.UnstakeRequest GetTestValue2()
      {
         HelloKusama.NetApiExt.Generated.Model.pallet_fast_unstake.types.UnstakeRequest result;
         result = new HelloKusama.NetApiExt.Generated.Model.pallet_fast_unstake.types.UnstakeRequest();
         result.Stash = new HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
         result.Stash = this.GetTestValue3();
         result.Checked = new HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT34();
      ...
      public HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT34 GetTestValue4()
      {
         HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT34 result;
         result = new HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT34();
      ...
      public async System.Threading.Tasks.Task TestHead()
      {
         ...
         HelloKusama.NetApiExt.Generated.Model.pallet_fast_unstake.types.UnstakeRequest mockupValue = this.GetTestValue2();
         ...
         HelloKusama.NetApiExt.Generated.Model.pallet_fast_unstake.types.UnstakeRequest rpcResult = await rpcClient.GetHead();
