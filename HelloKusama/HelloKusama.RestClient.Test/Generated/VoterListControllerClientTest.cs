...
namespace HelloKusama.RestClient.Test.Generated
{
   ...
   public class VoterListControllerClientTest : ClientTestBase
   {
      ...
      public HelloKusama.NetApiExt.Generated.Model.pallet_bags_list.list.Node GetTestValue2()
      {
         HelloKusama.NetApiExt.Generated.Model.pallet_bags_list.list.Node result;
         result = new HelloKusama.NetApiExt.Generated.Model.pallet_bags_list.list.Node();
         result.Id = new HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
         result.Id = this.GetTestValue3();
         result.Prev = new Ajuna.NetApi.Model.Types.Base.BaseOpt<HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>();
         result.Prev.Create(this.GetTestValue4());
         result.Next = new Ajuna.NetApi.Model.Types.Base.BaseOpt<HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>();
      ...
      public async System.Threading.Tasks.Task TestListNodes()
      {
         ...
         HelloKusama.NetApiExt.Generated.Model.pallet_bags_list.list.Node mockupValue = this.GetTestValue2();
         ...
         HelloKusama.NetApiExt.Generated.Model.pallet_bags_list.list.Node rpcResult = await rpcClient.GetListNodes(mockupKey);
      ...
      public HelloKusama.NetApiExt.Generated.Model.pallet_bags_list.list.Bag GetTestValue9()
      {
         HelloKusama.NetApiExt.Generated.Model.pallet_bags_list.list.Bag result;
         result = new HelloKusama.NetApiExt.Generated.Model.pallet_bags_list.list.Bag();
         result.Head = new Ajuna.NetApi.Model.Types.Base.BaseOpt<HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>();
         result.Head.Create(this.GetTestValue10());
         result.Tail = new Ajuna.NetApi.Model.Types.Base.BaseOpt<HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>();
      ...
      public async System.Threading.Tasks.Task TestListBags()
      {
         ...
         // Construct new RPC client to test with.
         VoterListControllerClient rpcClient = new VoterListControllerClient(_httpClient, subscriptionClient);
         HelloKusama.NetApiExt.Generated.Model.pallet_bags_list.list.Bag mockupValue = this.GetTestValue9();
         ...
         HelloKusama.NetApiExt.Generated.Model.pallet_bags_list.list.Bag rpcResult = await rpcClient.GetListBags(mockupKey);
