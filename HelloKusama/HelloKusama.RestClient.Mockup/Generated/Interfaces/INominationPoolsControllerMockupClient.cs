...
namespace HelloKusama.RestClient.Mockup.Generated.Interfaces
{
   ...
   public interface INominationPoolsControllerMockupClient
   {
      ...
      Task<bool> SetPoolMembers(PoolMember value, HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
      ...
      Task<bool> SetMetadata(BoundedVecT33 value, U32 key);
      Task<bool> SetCounterForMetadata(U32 value);
      Task<bool> SetLastPoolId(U32 value);
      Task<bool> SetReversePoolIdLookup(U32 value, HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
