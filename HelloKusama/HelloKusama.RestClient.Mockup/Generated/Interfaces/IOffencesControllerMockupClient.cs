...
namespace HelloKusama.RestClient.Mockup.Generated.Interfaces
{
   ...
   public interface IOffencesControllerMockupClient
   {
      ...
      Task<bool> SetConcurrentReportsIndex(BaseVec<H256> value, BaseTuple<HelloKusama.NetApiExt.Generated.Types.Base.Arr16U8, BaseVec<U8>> key);
      Task<bool> SetReportsByKindIndex(BaseVec<U8> value, HelloKusama.NetApiExt.Generated.Types.Base.Arr16U8 key);
   }
}
