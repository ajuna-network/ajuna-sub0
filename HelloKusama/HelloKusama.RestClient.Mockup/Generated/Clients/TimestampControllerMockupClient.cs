...
namespace HelloKusama.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class TimestampControllerMockupClient : MockupBaseClient, ITimestampControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Timestamp/Now", value.Encode(), HelloKusama.NetApiExt.Generated.Storage.TimestampStorage.NowParams());
      }
      public async Task<bool> SetDidUpdate(Bool value)
      {
         return await SendMockupRequestAsync(_httpClient, "Timestamp/DidUpdate", value.Encode(), HelloKusama.NetApiExt.Generated.Storage.TimestampStorage.DidUpdateParams());
      }
   }
}
