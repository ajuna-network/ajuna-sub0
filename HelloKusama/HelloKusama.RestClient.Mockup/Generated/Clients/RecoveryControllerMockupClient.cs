...
namespace HelloKusama.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class RecoveryControllerMockupClient : MockupBaseClient, IRecoveryControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Recovery/Recoverable", value.Encode(), HelloKusama.NetApiExt.Generated.Storage.RecoveryStorage.RecoverableParams(key));
      }
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Recovery/ActiveRecoveries", value.Encode(), HelloKusama.NetApiExt.Generated.Storage.RecoveryStorage.ActiveRecoveriesParams(key));
      }
      public async Task<bool> SetProxy(AccountId32 value, AccountId32 key)
      {
         return await SendMockupRequestAsync(_httpClient, "Recovery/Proxy", value.Encode(), HelloKusama.NetApiExt.Generated.Storage.RecoveryStorage.ProxyParams(key));
      }
   }
}
