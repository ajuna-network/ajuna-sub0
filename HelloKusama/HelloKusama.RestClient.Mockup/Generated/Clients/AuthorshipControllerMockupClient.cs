...
namespace HelloKusama.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class AuthorshipControllerMockupClient : MockupBaseClient, IAuthorshipControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Authorship/Uncles", value.Encode(), HelloKusama.NetApiExt.Generated.Storage.AuthorshipStorage.UnclesParams());
      }
      public async Task<bool> SetAuthor(AccountId32 value)
      {
         return await SendMockupRequestAsync(_httpClient, "Authorship/Author", value.Encode(), HelloKusama.NetApiExt.Generated.Storage.AuthorshipStorage.AuthorParams());
      }
      public async Task<bool> SetDidSetUncles(Bool value)
      {
         return await SendMockupRequestAsync(_httpClient, "Authorship/DidSetUncles", value.Encode(), HelloKusama.NetApiExt.Generated.Storage.AuthorshipStorage.DidSetUnclesParams());
      }
   }
}
