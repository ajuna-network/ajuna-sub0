...
namespace HelloKusama.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class VestingControllerMockupClient : MockupBaseClient, IVestingControllerMockupClient
   {
      ...
      public async Task<bool> SetVesting(BoundedVecT25 value, HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await SendMockupRequestAsync(_httpClient, "Vesting/Vesting", value.Encode(), HelloKusama.NetApiExt.Generated.Storage.VestingStorage.VestingParams(key));
      }
      public async Task<bool> SetStorageVersion(EnumReleases value)
      {
         return await SendMockupRequestAsync(_httpClient, "Vesting/StorageVersion", value.Encode(), HelloKusama.NetApiExt.Generated.Storage.VestingStorage.StorageVersionParams());
      }
   }
}
