...
namespace HelloKusama.RestService.Generated.Storage
{
    ...
    public interface ITipsStorage : IStorage
    {
        ...
        /// </summary>
        HelloKusama.NetApiExt.Generated.Model.pallet_tips.OpenTip GetTips(string key);
    ...
    public sealed class TipsStorage : ITipsStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<HelloKusama.NetApiExt.Generated.Model.pallet_tips.OpenTip> _tipsTypedStorage;
        ...
        {
            this.TipsTypedStorage = new TypedMapStorage<HelloKusama.NetApiExt.Generated.Model.pallet_tips.OpenTip>("Tips.Tips", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<HelloKusama.NetApiExt.Generated.Model.pallet_tips.OpenTip> TipsTypedStorage
        {
            get
            {
        ...
        ///  guaranteed to be a secure hash.
        /// </summary>
        public HelloKusama.NetApiExt.Generated.Model.pallet_tips.OpenTip GetTips(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (TipsTypedStorage.Dictionary.TryGetValue(key, out HelloKusama.NetApiExt.Generated.Model.pallet_tips.OpenTip result))
            {
                return result;
            }
            else
