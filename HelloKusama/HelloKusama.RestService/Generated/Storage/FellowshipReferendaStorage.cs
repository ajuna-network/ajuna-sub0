...
namespace HelloKusama.RestService.Generated.Storage
{
    ...
    public interface IFellowshipReferendaStorage : IStorage
    {
        ...
        /// </summary>
        HelloKusama.NetApiExt.Generated.Model.pallet_referenda.types.EnumReferendumInfo GetReferendumInfoFor(string key);
        ...
        /// </summary>
        HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT20 GetTrackQueue(string key);
    ...
    public sealed class FellowshipReferendaStorage : IFellowshipReferendaStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<HelloKusama.NetApiExt.Generated.Model.pallet_referenda.types.EnumReferendumInfo> _referendumInfoForTypedStorage;
        
        /// <summary>
        /// _trackQueueTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT20> _trackQueueTypedStorage;
        ...
        {
            this.ReferendumCountTypedStorage = new TypedStorage<Ajuna.NetApi.Model.Types.Primitive.U32>("FellowshipReferenda.ReferendumCount", storageDataProvider, storageChangeDelegates);
            this.ReferendumInfoForTypedStorage = new TypedMapStorage<HelloKusama.NetApiExt.Generated.Model.pallet_referenda.types.EnumReferendumInfo>("FellowshipReferenda.ReferendumInfoFor", storageDataProvider, storageChangeDelegates);
            this.TrackQueueTypedStorage = new TypedMapStorage<HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT20>("FellowshipReferenda.TrackQueue", storageDataProvider, storageChangeDelegates);
            this.DecidingCountTypedStorage = new TypedMapStorage<Ajuna.NetApi.Model.Types.Primitive.U32>("FellowshipReferenda.DecidingCount", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<HelloKusama.NetApiExt.Generated.Model.pallet_referenda.types.EnumReferendumInfo> ReferendumInfoForTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT20> TrackQueueTypedStorage
        {
            get
            {
        ...
        ///  Information concerning any given referendum.
        /// </summary>
        public HelloKusama.NetApiExt.Generated.Model.pallet_referenda.types.EnumReferendumInfo GetReferendumInfoFor(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ReferendumInfoForTypedStorage.Dictionary.TryGetValue(key, out HelloKusama.NetApiExt.Generated.Model.pallet_referenda.types.EnumReferendumInfo result))
            {
                return result;
            }
            else
        ...
        ///  This should be empty if `DecidingCount` is less than `TrackInfo::max_deciding`.
        /// </summary>
        public HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT20 GetTrackQueue(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (TrackQueueTypedStorage.Dictionary.TryGetValue(key, out HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT20 result))
            {
                return result;
            }
            else
