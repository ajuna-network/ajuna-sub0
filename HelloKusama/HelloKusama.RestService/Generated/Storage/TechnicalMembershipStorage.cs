...
namespace HelloKusama.RestService.Generated.Storage
{
    ...
    public interface ITechnicalMembershipStorage : IStorage
    {
        ...
        /// </summary>
        HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT14 GetMembers();
    ...
    public sealed class TechnicalMembershipStorage : ITechnicalMembershipStorage
    {
        ...
        /// </summary>
        private TypedStorage<HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT14> _membersTypedStorage;
        ...
        {
            this.MembersTypedStorage = new TypedStorage<HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT14>("TechnicalMembership.Members", storageDataProvider, storageChangeDelegates);
            this.PrimeTypedStorage = new TypedStorage<HelloKusama.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>("TechnicalMembership.Prime", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _membersTypedStorage property
        /// </summary>
        public TypedStorage<HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT14> MembersTypedStorage
        {
            get
            {
        ...
        ///  The current membership, stored as an ordered Vec.
        /// </summary>
        public HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT14 GetMembers()
        {
