...
namespace HelloKusama.RestService.Generated.Storage
{
    ...
    public interface IBountiesStorage : IStorage
    {
        ...
        /// </summary>
        HelloKusama.NetApiExt.Generated.Model.pallet_bounties.Bounty GetBounties(string key);
        
        /// <summary>
        /// >> BountyDescriptions
        ///  The description of each bounty.
        /// </summary>
        HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT30 GetBountyDescriptions(string key);
        
        /// <summary>
        /// >> BountyApprovals
        ///  Bounty indices that have been approved but not yet funded.
        /// </summary>
        HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT15 GetBountyApprovals();
    }
    ...
    public sealed class BountiesStorage : IBountiesStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<HelloKusama.NetApiExt.Generated.Model.pallet_bounties.Bounty> _bountiesTypedStorage;
        
        /// <summary>
        /// _bountyDescriptionsTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT30> _bountyDescriptionsTypedStorage;
        
        /// <summary>
        /// _bountyApprovalsTypedStorage typed storage field
        /// </summary>
        private TypedStorage<HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT15> _bountyApprovalsTypedStorage;
        ...
        public BountiesStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.BountiesTypedStorage = new TypedMapStorage<HelloKusama.NetApiExt.Generated.Model.pallet_bounties.Bounty>("Bounties.Bounties", storageDataProvider, storageChangeDelegates);
            this.BountyDescriptionsTypedStorage = new TypedMapStorage<HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT30>("Bounties.BountyDescriptions", storageDataProvider, storageChangeDelegates);
            this.BountyApprovalsTypedStorage = new TypedStorage<HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT15>("Bounties.BountyApprovals", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<HelloKusama.NetApiExt.Generated.Model.pallet_bounties.Bounty> BountiesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT30> BountyDescriptionsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT15> BountyApprovalsTypedStorage
        {
            get
            {
        ...
        ///  Bounties that have been made.
        /// </summary>
        public HelloKusama.NetApiExt.Generated.Model.pallet_bounties.Bounty GetBounties(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (BountiesTypedStorage.Dictionary.TryGetValue(key, out HelloKusama.NetApiExt.Generated.Model.pallet_bounties.Bounty result))
            {
                return result;
            }
            else
        ...
        ///  The description of each bounty.
        /// </summary>
        public HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT30 GetBountyDescriptions(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (BountyDescriptionsTypedStorage.Dictionary.TryGetValue(key, out HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT30 result))
            {
                return result;
            }
            else
        ...
        ///  Bounty indices that have been approved but not yet funded.
        /// </summary>
        public HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT15 GetBountyApprovals()
        {
