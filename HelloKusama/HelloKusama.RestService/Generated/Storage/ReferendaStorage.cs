...
namespace HelloKusama.RestService.Generated.Storage
{
    ...
    public interface IReferendaStorage : IStorage
    {
        ...
        /// </summary>
        HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT18 GetTrackQueue(string key);
    ...
    public sealed class ReferendaStorage : IReferendaStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT18> _trackQueueTypedStorage;
        ...
        {
            this.ReferendumCountTypedStorage = new TypedStorage<Ajuna.NetApi.Model.Types.Primitive.U32>("Referenda.ReferendumCount", storageDataProvider, storageChangeDelegates);
            this.ReferendumInfoForTypedStorage = new TypedMapStorage<HelloKusama.NetApiExt.Generated.Model.pallet_referenda.types.EnumReferendumInfo>("Referenda.ReferendumInfoFor", storageDataProvider, storageChangeDelegates);
            this.TrackQueueTypedStorage = new TypedMapStorage<HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT18>("Referenda.TrackQueue", storageDataProvider, storageChangeDelegates);
            this.DecidingCountTypedStorage = new TypedMapStorage<Ajuna.NetApi.Model.Types.Primitive.U32>("Referenda.DecidingCount", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT18> TrackQueueTypedStorage
        {
            get
            {
        ...
        ///  This should be empty if `DecidingCount` is less than `TrackInfo::max_deciding`.
        /// </summary>
        public HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT18 GetTrackQueue(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (TrackQueueTypedStorage.Dictionary.TryGetValue(key, out HelloKusama.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT18 result))
            {
                return result;
            }
            else
